...
namespace OAUTHandJWT.Controllers
{
    ...
    public class CategoryProductsController : ControllerBase
    {
        ...
        public CategoryProductsController(HotelBaseContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != categoryProduct.IdCategoryProduct)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<CategoryProduct>> PostCategoryProduct(CategoryProduct categoryProduct)
        {
            ...
            return CreatedAtAction("GetCategoryProduct", new { id = categoryProduct.IdCategoryProduct }, categoryProduct);
        }
        ...
        {
            return _context.CategoryProducts.Any(e => e.IdCategoryProduct == id);
        }
    }
}
